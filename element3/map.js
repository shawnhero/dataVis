...
namespace3.main = function(){
    ...
    function city_mouseover(that){
        ...
        tooltip3.select("#title_state").text("State");
        tooltip3.select("#popstate").text(this_state);

        tooltip3.select("#title_city").text("City");
        ...
        if(val_option=='tp'){
            ...
            tooltip3.select("#title_tpd").text("Total Payments Per Discharge");
    ...
    function city_mouseout(that){
        d3.select(that)
            .classed("select", false);
                    // delete the tooltip
        d3.select("#popup3").style("visibility", "hidden");
    ...
    call3 = function(sid, val){
        ...
        var flag = true;
        var tooltip3 = d3.select("#popup3");
        var provider_tooltip = d3.select("#popup_pro");
                    ...
                    for(var key in allpros){
                        ...
                        pro_element.append('circle')
                            ...
                            .attr('opacity', function(){
                                if(this_pro[str]==maxObj(allpros, str)){
                                    return 1;
                                }
                                var opscale = d3.scale.linear()
                                    .range([0.3, 1])
                                    .domain(
                                        [minObj(allpros, str), maxObj(allpros, str)]);
                                return opscale(this_pro[str]);
